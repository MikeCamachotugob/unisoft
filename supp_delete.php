...
include('../connection/connect.php');
	...
	if(isset($_POST['supp_id'])){
		...
		$_SESSION['current_page'] = "supp_delete";
	}
	if($_SESSION['current_page'] == "supp_delete"){
		$_SESSION['current_page'] = "supp_delete";
...
<p id = "company_title"><b>delete suppliant information</b></p>

<a id = "back_button" href = "../pages/supp_view.php?ret_page" >back</a>
<a id = "btn_delete" onclick="return confirmation();"
	href = "../php_script/supp_proc_delete.php?delete=<?php echo $user_data['supp_id']; ?>" >delete</a>
...
if(confirm("this suppliant will be deleted if you click ok.."))
{
	
	if(confirm("the suppliant information will be stored in archive page .. click ok to proceed.."))
		{ return true;
			}else{ return false; }
